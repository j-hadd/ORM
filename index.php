...
<?php
include_once('simple_response.php');
...
$db_connector = new _pdo($dsn, $db_user, $db_password, $response);

/* the object used to fotmate the db requests */
$request_maker = new MySQL();
?>
...
$cfg_records = array();
$records = new records($db_connector, $request_maker, $cfg_records);

include_once('record.php');
$cfg_record = array();
$record = new record($db_connector, $request_maker, $cfg_record);
?>
